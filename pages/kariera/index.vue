<template>
	<main>
		...
		<HeroBig imgUrl="/kariera/kariera-hero.jpg">
			...
			<h2>
				Vítej v kariérní sekci agentury Miranda. Jsme tým nadšenců, kteří spojují firmy se zákazníky na základě dat, příběhů a
				hodnot. Pokud hledáš příležitost růst, učit se a sdílet své nápady v dynamickém a přátelském prostředí, jsi na správném
				místě.
			</h2>
		</HeroBig>
		<!-- OFFICE BANNER -->
		<section class="office container">
			<div class="office__content">
				...
				<p>
					Vítej v našich moderních kancelářích v holešovické Marině, kde vymýšlíme strategie, projekty a nápady, které překonávají
					očekávání našich klientů. Naše kanceláře nejsou jen místem, kde pracujeme. Jsou symbolem našeho závazku k vytváření
					silné firemní kultury, podporují naši produktivitu a jsou místem, kde se rodí skvělé nápady. Přijď nás navštívit a
					prožij tu jedinečnou atmosféru na vlastní kůži!
				</p>
		...
		<section id="scroll" class="container">
			<div class="miranda-grid">
				<div class="item large">
					...
					<p>
						V Mirandě věříme v sílu týmu. Pravidelné teambuildingy a firemní večírky nám pomáhají posilovat naše vztahy a
						vytvářet nezapomenutelné vzpomínky. Když jsme spolu, jsme silnější. A zábavnější.
					</p>
				</div>
				...
				<div class="item center">
					...
					<p>
						Během 15 let na trhu jsme byli svědky rychlého růstu a proměny digitálního obchodu. Ale místo toho, abychom byli
						pouhými pozorovateli, stáli jsme na čele této revoluce. S naším týmem talentovaných odborníků jsme nejen sledovali
						trendy, ale také je sami vytvářeli.
					</p>
				</div>
			</div>
		</section>
		...
		<section class="lide">
			<div class="lide__content container">
				...
				<p>
					Poznej náš tým - skutečné hvězdy agentury Miranda. Každý z nás přispívá troškou svého talentu a jedinečnou osobností.
					Podívej se, kdo stojí za našimi úspěšnými projekty a kdo by mohl být tvým budoucím kolegou!
				</p>
			</div>
			...
			<div class="container">
				<div class="columns col-4-6 align-center">
					<div class="column">
						...
						<p>
							Místo u stolu máme připravené, možná čeká právě na tebe. Vyplň formulář níže a pošli nám své CV. Obratem se Ti
							ozveme.
						</p>
...
<script setup>
	...
	useHead({
		title: 'Kariéra u Miranda Media: Přidejte se k nám a tvořte s námi budoucnost',
		meta: [
			{
				name: 'description',
				content:
					'Rozvíjejte svou kariéru s námi v Miranda Media. Nabízíme široké spektrum pracovních příležitostí a možností pro vaše profesní růst. Připojte se k naší společnosti a dejte svému kariérnímu rozvoji nový impuls.',
			},
		],
	})
</script>
