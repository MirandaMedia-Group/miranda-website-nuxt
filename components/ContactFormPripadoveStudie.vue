<template lang="">
	<div class="form-wrapper">
		<div class="columns col-2 container">
			<div class="column">
				<h2>Máte zájem o spolupráci?</h2>
				<div class="columns-2">
					<img class="form-image" src="/MichalBaloun.jpg" alt="Michal Baloun - Zakladatel" loading="lazy" />
					<div class="form-text">
						<h3>Michal Baloun</h3>
						<p class="description">Partner<br />MirandaMedia Group s.r.o.</p>
			...
			<div class="column form-col">
				...
				<form v-else @submit.prevent="sendForm">
					<div class="form-row">
						<input type="text" id="jemno" name="jmeno" placeholder="Jméno a příjmení*" :ref="form.jmeno" required />
					</div>
					<div class="form-row">
