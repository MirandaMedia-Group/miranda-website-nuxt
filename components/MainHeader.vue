					...
					<a href="https://mirandamedia.sk/">
						<svg id="sk" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
							...
							<path
								id="Path_7"
								data-name="Path 7"
								d="M29.853,168.6H7.225a12,12,0,0,0,22.628,0Z"
								transform="translate(-6.539 -152.6)"
								fill="#ee1c25" />
							<path
								id="Path_8"
								data-name="Path 8"
							...
							<path
								...
								data-name="Path 9"
								d="M137.493,99.277Z"
								transform="translate(-124.445 -89.856)"
								fill="#f3f4f5" />
							<path
								id="Path_10"
								data-name="Path 10"
								d="M115.379,99.277Z"
								transform="translate(-104.429 -89.856)"
								fill="#f3f4f5" />
							<path
								id="Path_11"
								data-name="Path 11"
								d="M117.374,91.325Z"
								transform="translate(-106.235 -82.658)"
								fill="#f3f4f5" />
							<path
								id="Path_12"
								data-name="Path 12"
								...
								transform="translate(-33.102 -44.508)"
								fill="#fff" />
							<path
								id="Path_13"
								data-name="Path 13"
								...
								transform="translate(-37.718 -50.282)"
								fill="#ee1c25" />
							<path
								id="Path_14"
								data-name="Path 14"
								...
								transform="translate(-57.708 -54.923)"
								fill="#fff" />
							<path
								id="Path_15"
								data-name="Path 15"
								...
								transform="translate(-47.919 -126.895)"
								fill="#0b4ea2" />
						</svg>
						SK
					</a>
